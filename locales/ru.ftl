start = Привет {$first_name}, это ваш универсальный Telegram-бот для удобного общения с PDF.
        ...
        • Расширенное хранилище файлов: 25 файлов в месяц (максимум 100 страниц)
        ...
        <b>Максимальный размер файла:</b> 20МБ

        Для поддержки свяжитесь с нами по адресу pdf_chat_bot_support@proton.me

        • Напишите /help, чтобы отобразить все доступные команды
        • Напишите /about, чтобы отобразить информацию об этом боте
...
payment_description = Подписка для продвинутого использования.
                      ...
                      • 100 страниц для каждого документа
...
max_file_size_warning = ⚠️ Максимальный размер файла не должен превышать 20 МБ
